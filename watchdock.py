...
class WatchdockFrame(wx.Frame):
    ...
    def __set_properties(self):
        ...
        self.btn_stop.SetToolTip("Stop selected container")
        self.btn_stop.Enable(False)
        self.btn_restart.SetMinSize((60, -1))
        self.btn_restart.SetToolTip("Restart selected container")
        self.btn_restart.Enable(False)
        self.btn_start.SetMinSize((60, -1))
        self.btn_start.SetToolTip("Start selected container or image")
        self.btn_start.Enable(False)
        self.btn_save.SetMinSize((60, -1))
        self.btn_save.SetToolTip("commit selected container \nto default image or other image")
        self.btn_save.Enable(False)
        self.btn_del.SetMinSize((60, -1))
        self.btn_del.SetToolTip("Delete selected image")
