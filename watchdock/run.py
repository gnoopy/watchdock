...
class WatchdockFrame(wx.Frame):
    ...
    def OnClickedSave(self, event):  # wxGlade: WatchdockFrame.<event_handler>
        ...
        dlg = CommitDialog(self,style= wx.ICON_QUESTION )
        ...
        if result == wx.ID_OK:
            ...
            print('You canceled')
        dlg.Destroy()
        #TODO:docker container commit -a "Jeenwoo Park" -m "wxpython ci environment" 27c2fa85dc0a gnoopy/wxpython4-py2-ci:v1

    def OnClickedPush(self, event):  # wxGlade: WatchdockFrame.<event_handler>
        print("Event handler 'OnClickedPush' not implemented!")
        event.Skip()
...
class CommitDialog(wx.Dialog):
    def __init__(self, repo, *args, **kwds):
        ...
        self.Bind(wx.EVT_TEXT_ENTER, self.OnEnteredImgName, self.txt_img_name_tag)
    ...
    def __do_layout(self):
        ...
        label_5 = wx.StaticText(self, wx.ID_ANY, "\nSelected container image will be commited to the image you designate.\nPlease enter repository name with a tag of the target image.\nCommit message and Your name are optional.")
    ...
    def OnEnteredImgName(self, event):  # wxGlade: CommitDialog.<event_handler>
        print("Event handler 'OnEnteredImgName' not implemented!")
        event.Skip()

    def OnClickedCommit(self, event):  # wxGlade: CommitDialog.<event_handler>
        print("Event handler 'OnClickedCommit' not implemented!")
        event.Skip()

    def OnClickedCancel(self, event):  # wxGlade: CommitDialog.<event_handler>
        print("Event handler 'OnClickedCancel' not implemented!")
        self.Close()
        event.Skip()
